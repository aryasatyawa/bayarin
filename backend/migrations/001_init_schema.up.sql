...
-- Grant privileges to bayarin_user
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO bayarin_user;

GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO bayarin_user;
